...
@section('content')
    <div class="main">
        <div class="grid wide">
            ...
            @endif
            <div class="h2"
                style="font-weight:700px;margin-top:13px; margin-bottom:65px;font-size:45px;font-weight:bold;">
                Personal Information</div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-4 bg-light"
                        style="border:1px solid transparent;border-radius:10px;background:#F1F1F1;">
                        <div class="card-body text-center" style="background: var(--clr-bg-card-avatar)">
                            ...
                            <h5 class="h3 fullName my-3" style="text-transform: capitalize;">
                ...
                <div class="col-lg-8">
                    <div class="card mb-5">
                        <div class="card-body" style="background: var(--clr-bg-card-avatar)">
                            <div class="row">
                                <div class="col-sm-2">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <p class="mb-0" style="color:#828282;">Date of birth</p>
                                </div>
                                <div class="col-sm-10">
                                    <div class="d-flex justify-content-between">
                                        <p class="mb-0">
                    ...
                    <div class="d-flex flex-row-reverse ">
                        ...
                        <button type="button" class="btn btn-primary"
                            style="border-radius:10px;font-family: 'Lato';
                                        font-style: normal; padding:12px 28px;font-weight:700;font-size:20px;line-height:24px;"
